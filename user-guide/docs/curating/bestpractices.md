...
In alignment with FAIR for Research Software (FAIR4RS) [recommendations](https://www.nature.com/articles/s41597-022-01710-x), research software published in DDR should be feature complete and designed to be actively maintained, enhanced and versioned. It should also include sufficient documentation about its provenance and how to use it. A [CodeMeta file can be filled out online](https://codemeta.github.io/codemeta-generator/) and uploaded to the GitHub repository for publication using the Research Software Project Type, or uploaded along with the software files to a Project Type Other.  When filling the CodeMeta file, it is important to include as much information as possible, which allows for others to understand, reuse and attribute your work.
...
4. A Jupyter Notebook can be published as a stand-alone research software as long as it fits with DDR's Research Software Policies.
