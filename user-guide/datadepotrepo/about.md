...
In operation since 2016, the DDR preserves natural hazards research data since its inception, and also provides access to legacy datasets dating from about 2005. These legacy data were generated as part of the NSF-supported Network for Earthquake Engineering Simulation (NEES), a predecessor to NHERI. Legacy data and metadata belonging to NEES were transferred to the DDR for continuous preservation and access: [published NEES data](/data/browser/public/nees.public).
